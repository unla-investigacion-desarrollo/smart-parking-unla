...
const IconoOcupado = props => <Avatar.Icon {...props} icon="map-marker" color='#ff1744' backgroundColor='transparent' size="60"/>
...
export default function MyCardHome({sensor,index}){
  ...
  return(
    ...
    <Card.Content>
      ...
      <Text variant="bodyMedium">is free: {sensor.free} {sensor.free ? <GreenFlag/> : <RedFlag/>}</Text>
